...
class KYCController extends Controller
{
    ...
    {
        // Use mock service if in development or no API key configured
        if (config('app.env') === 'local' || !config('kyc.providers.dojah.api_key')) {
            $this->ninService = new MockNINValidationService();
        } else {
            $this->ninService = new NINValidationService();
        }
    }
